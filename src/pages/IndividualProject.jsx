    ...
    return (
      <div>
        ...
        <section className="portfolio">
          <Element name="element1" className="portfolio"   style={{
            ...
            <ol style={{ listStyleType: "upper-roman" }}>
              <li className="researchQuestions">
                ...
                <div className="researchQuestionsSection">
                  ...
                  that the best solution for my portfolio would be to have a sub
                  navigation on the project pages to facilitate the users
              ...
              <li className="researchQuestions">
                ...
                <div className="researchQuestionsSection">
                  <b>Conclusion to Question:</b>
                  For this question, I refered to my benchmark creation research
                  to see how other professionals were dividing the content on
                  their portfolio websites. Most of the seemed to be divided by
                  just the project themselves so I decided to do the same in my
                  portfolio. Because I had to focus on only three projects, I
                  thought it would be appropriate to add the projects as their
                  own menu items that can be accessed directly through my home
                  page.
                </div>
              </li>
              <li className="researchQuestions">
                ...
                <div className="researchQuestionsSection">
                  ...
                  trends, common practices, and innovative approaches which are
                  all important factors that professionals are looking for in
                  portfolios. I was able to tailor my own portfolio to align
                  with the expectations of my assesor and future employees and
                  show my work in a compelling and competitive manner.
                </div>
              </li>
              <li className="researchQuestions">
                <b>
                ...
                <div className="researchQuestionsSection">
                  ...
                  professional and professional identity and style in a website
                  portfolio. By curating images, colors, typography, and other
                  design elements that resonate with my own personal aesthetic
                  and professional values, I was able to create a visual
                  representation of my unique approach. I believe the moodboard
                  will give visitors a glimpse into my own design preferences,
                  influences, and the overall mood I aim to evoke in my work,
                  helping them understand my design perspective and hopefully
                  making a lasting impression on my assessors and future
                  employers. Some of these preferences include:
                  <ol style={{ listStyleType: "decimal" }}>
                    <li>
                      Animations - On homepage and using the typing animation on
                      titles and text
                    </li>
