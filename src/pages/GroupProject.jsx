      ...
      <div>
        ...
        <section className="portfolio">
          ...
          <Element name="element2" className="portfolio">
            ...
            <div className="IndividualLText">
              <p className="indent">
                The first step in our research phase was to create a main
                research question and sub research questions to create a guide
                of what factors of youth work and the online world that we will
                examine throughout this project. Our main research question was:
              </p>
              <b
                className="indent"
                style={{
              ...
              <ol
                style={{ pointerEvents: "none", listStyleType: "upper-roman" }}
              >
                <li className="researchQuestions">
                  ...
                  <div className="researchQuestionsSection">
                    ...
                    To answer this sub question, we decided that it would be
                    wise to not only research what the role of a youth worker
                    is, but to also speak with real life youth workers to make
                    sure we were covering all of their needs. Through our
                    research, we decided to define youth work as a term
                    encompassing many different activities that support and
                    engage young people, and it can be delivered by trained
                    professionals or volunteers in a variety of settings. The
                    main aims of youth work are to promote positive youth
                    development, encourage social incorporation and well-being,
                    and empower young people to shape their own futures.
                  </div>
                </li>
                <li className="researchQuestions">
                  <b>
                  ...
                  <div className="researchQuestionsSection">
                    ...
                    study and expert interviews. We wanted , but also we wanted
                    to speak to Dynamos and Pitstops youth workers to better
                    understand their specific tasks as we were focusing on
                    finding a solution for youth workers in Eindhoven primarily.
                    From our literature study, we defined youth workers as a
                    trained professional that caters to the well-being of the
                    youth. They may work in different environments like at
                    schools, government agencies, and youth agencies. They can
                    also specialize in a particular area of practice such as
                    child welfare or mental health.We also gained some useful
                    insights from the expert interviews like the fact that
                    Dynamo already has some youth workers, called Digicoaches,
                    that focus their efforts in the online world. We were also
                    able to define two different youth worker personas with our
                    findings, the first being a younger social worker that is
                    familiar with the online world (like a Digicoach from
                    Dynamo)and the other being an older social worker that is
                    scared of the dangers of being online.
                  </div>
                </li>
                <li className="researchQuestions">
                  <b>
                  ...
                  <div className="researchQuestionsSection">
                    <b>CMD Methods Explored:</b> Literature Study, Trend
                    Analysis, Online Analytics
                  </div>
                  <div className="researchQuestionsSection">
                  ...
                  <div className="researchQuestionsSection">
                    <b>Conclusion to Question:</b>
                    Through literary research and looking at online analytics,
                    we were able to determine the social media we felt like it
                    was not only the most popular but the most beneficial
                    platform for youth workers to conduct online youth work on.
                    These were Instagram, Tiktok, Discord and Snapchat. In the
                    beginning, we had not included Snapchat as a social media to
                    focus on as it is not as popular as it once was worldwide.
                    However, it is still quite popular in the Netherlands and
                    after speaking to our stakeholder and Matheus, a youth
                    worker at Pitstop, we came to the agreement to add it too as
                    they were already utilizing Snapchat as a way to gain
                    insights on dangerous activities happening in their
                    neighborhoods. These methods they used on Snapchat could be
                    very useful for other social workers to learn about and
                    implement in their own cities.
                  </div>
                </li>
                <li className="researchQuestions">
                  <b>
                    What does other international youth work currently do to
                  ...
                  <div className="researchQuestionsSection">
                    <b>Conclusion to Question:</b>
                    As a group, we all wanted to address this question. We
                    decided that instead of having one group member focusing on
                    this question we could all pick a country and research their
                ...
                <li className="researchQuestions">
                  ...
                  <div className="researchQuestionsSection">
                    <b>Example of Key Research Terms:</b> Effects of Social
                    Media, Benefits of being on social media, negative impact of
                  ...
                  <div className="researchQuestionsSection">
                    ...
                    opinions on the topic and not to rely solely on our own
                    points of view. Through the literary research done, we were
                    able to highlight some of the benefits of social media like
                    being able to communicate with family and friends around the
                    world, can be a source of entertainment, could be used as an
                    outlet for creativity, and creates many new employment
                    opportunities for people. However, like with most things, it
                    is important to note that there are also many things that
                    can be viewed as bad/dangerous about social media. Some of
                    these are over or misuse of social media can cause
                    Depression and anxiety if social media interaction is
                    prioritized over in-person relationships, self image issues,
                    can be used as a distraction from work, and cause feelings
                    of loneliness. There is also the very large issue of cyber
                    bullying which is still very unregulated and one of the most
                    significant negative outcomes of social media.
                  </div>
                </li>
                <li className="researchQuestions">
                  <b>
                  ...
                  <div className="researchQuestionsSection">
                    ...
                    Reliability in Youth Work, Trust in Governmental
                    Organizations
                  </div>
                  <div className="researchQuestionsSection">
                    <b>Conclusion to Question:</b>
                    ...
                    organization is. By reading through the following study,
                    2019 Edelman Trust Barometer Special Report Brand Trust, we
                    were able to distinguish the three main factors that affect
                    brand and organization trustworthiness and reliability:
                    ...
                    It is important to remember that at the end of the day,
                    people will view a youth center as an organization and if it
                    has any ties to the government/governmental organizations,
                    that can have a huge impact on the way they are perceived.
                    After conducting this literary research, we began
                    brainstorming to make sure our final concept would be
                    presenting social work and youth workers in the most
                    reliable and trustworthy way.
                  </div>
                </li>
                <li className="researchQuestions">
                  <b>
                    How can we educate social workers on the use of online
                    media?
                  </b>
                  <div className="researchQuestionsSection">
                    <b>CMD Methods Explored:</b> Literature Study,
                  ...
                  <div className="researchQuestionsSection">
                    <b>Example of Key Research Terms:</b> Best methods to
                    educate people online, what do social workers still need to
                    know?
                  </div>
                  <div className="researchQuestionsSection">
                    <b>Conclusion to Question:</b>
                    ...
                    approach designing and developing an educational platform.
                    One of our main findings was the importance of adding
                    elements of gamification to any kind of online platform, but
                    specifically for educational platforms. Nowadays, people
                    have lower attention spans and many kinds of digital
                    distractions. We wanted to find the best solution to the
                    present issue, and we realized that adding elements of
                    gamification like quests, awards, encouraging visuals and a
                    personalized element(feeling like you have a course made
                    just for you when selecting an archetype.)We also received
                    feedback in our testing sessions these gamified features
                    were a nice addition to our platform, which some even saying
                    that this would motivate for them to keep using and coming
                    back to the platform regularly.
                  </div>
                </li>
              </ol>
            </div>
